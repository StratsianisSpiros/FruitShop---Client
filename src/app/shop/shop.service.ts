...
export class ShopService {
  ...
  constructor(private http: HttpClient) { }
    ...
    getProducts(useCache: boolean) {
      ...
      params = params.append('sort', this.shopParams.sortProduct);
    ...
    getBrands() {
      ...
      return this.http.get<IBrand[]>(this.basUrl + 'products/brands').pipe(
        map(response => {
    ...
    getProductTypes() {
      ...
      return this.http.get<IProductType[]>(this.basUrl + 'products/types').pipe(
        map(response => {
          this.types = response;
          return response;
        })
